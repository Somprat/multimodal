...
for ckpt_path in "${ckpt_paths[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=${gpu_id} .venv/bin/python evaluation/simpler_env/simpler_env_inference.py --ckpt-path ${ckpt_path} --experiment-mode ${experiment_mode} ${precision_args[@]} \
