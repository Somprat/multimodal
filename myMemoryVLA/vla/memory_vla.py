...
EXPERIMENT_MODES = frozenset({"baseline", "query_episodic", "full"})
...
class MemoryVLA(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.use_query = experiment_mode in {"query_episodic", "full"}
        self.use_episodic = experiment_mode in {"query_episodic", "full"}
